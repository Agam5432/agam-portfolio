...
const DEFAULTS = {
  ...
  tagline:
    "Building production-grade web apps with real AI — computer vision, LLMs, and everything in between.",
  ...
  return (
    <section className="min-h-[calc(100vh-64px)] flex flex-col justify-center px-6 md:px-16 lg:px-24 py-16 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, rgba(108,99,255,0.10) 0%, transparent 70%)",
      ...
      >
        {(data.stats || []).map((s, i) => (
          ...
          >
            <div className="text-3xl md:text-4xl font-black text-[#f0f0f5]">
              {s.num}
            </div>
            <div
